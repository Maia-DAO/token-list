...
async function getOFTsPriceSource() {
    ...
    const res = await fetch('https://layerzeroscan.com/api/trpc/ofts.statsOverview,ofts.getOverviewMetrics,chains.top,chains.top,ofts.list?batch=1&input=%7B%222%22%3A%7B%22filters%22%3A%7B%22stage%22%3A%22mainnet%22%7D%7D%2C%223%22%3A%7B%22filters%22%3A%7B%22stage%22%3A%22mainnet%22%2C%22created%22%3A%7B%7D%7D%7D%2C%224%22%3A%7B%22request%22%3A%7B%22filters%22%3A%7B%22period%22%3A%221d%22%7D%2C%22sort%22%3A%7B%22key%22%3A%22transfers_24h%22%2C%22order%22%3A%22desc%22%7D%7D%2C%22pageIndex%22%3A0%2C%22pageSize%22%3A15%7D%7D')
...
async function main() {
    ...
    await Promise.all([
        backupFile(TOKEN_LIST_PATH),
        backupFile(INACTIVE_TOKEN_LIST_PATH)
    ])
    ...
    // Save files
    await Promise.all([
        writeJson(TOKEN_LIST_PATH, tokenList),
        writeJson(INACTIVE_TOKEN_LIST_PATH, inactiveTokenList)
    ])
